...
export const vZOO = new Token(ChainId.MAINNET, '0xf46F29950116cc374868A981861CA4F942eD7269', 18, 'vZOO', 'vZOO');
export const REX = new Token(ChainId.MAINNET, '0x01A2947D9E6F58572028fA9fC6A2511646345841', 18, 'REX', 'REX');
export const PLAY = new Token(ChainId.MAINNET, '0x69a0B487f287d8B41eC1D26bcD11D101C2577A6B', 18, 'PLAY', 'PLAY');
