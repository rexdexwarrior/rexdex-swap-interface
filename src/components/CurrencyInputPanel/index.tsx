import { Currency, Pair } from '@rexdexwarrior/sdk'
...
const CurrencySelect = styled.button<{ selected: boolean }>`
  ...
  :focus,
  :hover {
    background-color: ${({ selected, theme }) => (selected ? darken(0.05, '#04f9f4') : darken(0.05, '#04f9f4'))};
  }
`
      ...
      <Container hideInput={hideInput} >
        ...
        <InputRow style={hideInput ? { padding: '0', borderRadius: '8px'} : {}} selected={disableCurrencySelect}>
          {!hideInput && (
            <>
              <NumericalInput
                style={{backgroundColor:'transparent',color:'#04f9f4'}}
